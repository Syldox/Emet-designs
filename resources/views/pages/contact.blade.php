...
@section('title', '| Contact')
   ...
   <div class="container" style="margin-left: 155px;;margin-top: 100px">
   <a href="/contact"><img src="img/corp-help.png" alt="hotline"  style="margin-left: 110px; width:160px;" class="showcase-btn"></a>
       <h1>Contactez Emet-Designs </h1>
       <hr>
       ...
       <div class="container col-md-12"  style="margin-top: -100px;margin-left: -100px;">
           <div class="row">
               <div class="col-md-8 info-left " style="margin-top: 133px">
                   <div class="well well-sm">
                    ...
                    <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                               ...
                               <div class="col-md-12">
                                   <button type="submit" class="btn btn-warning pull-right" id="btnContactUs" style="background-color: #03080f; border-color: #f7f7f7;">
                                       Send Message</button>
                               </div>
                           </div>
                       </form>
               ...
               <div class="col-md-4" style="margin-top: -190px">
                   <form>
                       <legend><span class="glyphicon glyphicon-globe"></span> Office</legend>
                       <address>
                           <strong>Twitter, https://twitter.com/Emet-Designs</strong><br>
                           Emet-Designs Mali Niarela<br>
                           Bamako, Mali<abbr title="Phone">
                               P:</abbr>
                           +223 979 51 17 99 99 03
                       </address>
                       <address>
                           <a href="mailto:#">Emet-Designs@gmail.com</a>
                       </address>
                   </form>

                   {{--Google Maps --}}

                   <h1 style="margin-top:50px">Emet-Map </h1>
